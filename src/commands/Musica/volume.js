...
module.exports = class Volume extends Command {
  ...
  async run(message, args, prefix, author) {
    ...
    if(message.guild.me.voice.channel != null) {
      ...
      const volume = args[0]
     isNaN(volume) ? message.reply(`${Emojis.Errado} **|** Por favor, coloque um número!`) : player.setVolume(volume), await message.reply(`${Emojis.Certo} **|** Valor modificado para \`${volume}\`!`)
  }
}
